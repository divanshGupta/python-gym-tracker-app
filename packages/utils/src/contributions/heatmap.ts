...
import { ContributionEntry, ContributionWeek } from './types'

// Snaps a date back to the most recent Sunday
// If the date is already a Sunday, returns it unchanged
function snapToWeekStart(dateStr: string): string {
...
export function buildHeatmapGrid(
  ...
  const lookup = new Map<string, ContributionEntry>()
