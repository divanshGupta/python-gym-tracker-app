...
export const getWorkouts = (params?: WorkoutFilters) => 
  api.get("/workouts", { params })

export const getWorkout = (id: number) => 
  api.get(`/workouts/${id}`)

export const createWorkout = (data: WorkoutInput) => 
  api.post("/workouts", data)

export const updateWorkout = (id: number, data: Partial<WorkoutInput>) => 
...
export const getPersonalBests = () => 
  api.get("/stats/personal_bests")

export const getStreak = () =>
  api.get<StreakData>("/stats/streak")

export const getExerciseProgress = (exerciseId: number) =>
  api.get<ExerciseProgress>(`/stats/progress/${exerciseId}`)