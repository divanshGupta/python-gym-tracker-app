import { AlignLeft, Building2, LogOut, MapPin } from "lucide-react";
            ...
            {[
              ...
              >
                <p className="text-[20px] font-bold text-text-primary leading-none tabular-nums">
                  ...
                  {unit && (
                    <span className="text-[11px] font-normal text-text-tertiary ml-1">
                      {unit}
                    </span>
                  )}
                </p>
        ...
        <div className="bg-surface border border-border-default rounded-xl overflow-hidden">
          {[
            ...
            >
              ...
              <span className="text-[12px] text-text-tertiary w-16 shrink-0">
                {label}
              </span>
